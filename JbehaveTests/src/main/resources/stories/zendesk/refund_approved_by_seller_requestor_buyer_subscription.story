Story: Refund approved by Seller Requestor: buyer in portfolio subscription
...
Scenario: Create portfolio subscribtion and publish it for zendesk test
GivenStories:
   stories/mall/portfolio_subscribtion/buy_portfolio_subscribtion.story#{name:Create portfolio subscribtion and publish it}
Given Do nothing
...
Then I see text of notification with css selector .cx-wall-table__content contains: Tickeron refunded your payment
