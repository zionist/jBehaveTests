...
When I click on Copy and paste from brokerage account with css selector div.col-xs-6:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)
Then I see page header with css selector .spinner-container > h1:nth-child(1) is: Add Tickers
!-- # Add tickers.
When I click on ticker selection input with css selector textarea.form-control
And I type a aa aapl googl bla bla aaadx x y z into search fild with css selector textarea.form-control
And I wait small timeout
And I click on Add button with css selector div.col-xs-2:nth-child(1) > button:nth-child(1)
...
!-- And I click on Yes button with css selector button.btn-secondary:nth-child(1)
